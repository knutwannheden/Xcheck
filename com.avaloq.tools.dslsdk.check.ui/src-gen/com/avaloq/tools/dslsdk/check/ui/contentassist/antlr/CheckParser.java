...
* generated by Xtext
*/
package com.avaloq.tools.dslsdk.check.ui.contentassist.antlr;
...
public class CheckParser extends AbstractContentAssistParser {
	...
	@Override
	protected com.avaloq.tools.dslsdk.check.ui.contentassist.antlr.internal.InternalCheckParser createParser() {
		com.avaloq.tools.dslsdk.check.ui.contentassist.antlr.internal.InternalCheckParser result = new com.avaloq.tools.dslsdk.check.ui.contentassist.antlr.internal.InternalCheckParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFormalParameterAccess().getParameterAssignment_0(), "rule__FormalParameter__ParameterAssignment_0");
					put(grammarAccess.getFormalParameterAccess().getDefaultValueAssignment_2(), "rule__FormalParameter__DefaultValueAssignment_2");
					put(grammarAccess.getFormalParameterAccess().getLabelAssignment_3(), "rule__FormalParameter__LabelAssignment_3");
					put(grammarAccess.getContextAccess().getContextTypeAssignment_1(), "rule__Context__ContextTypeAssignment_1");
					put(grammarAccess.getContextAccess().getItAssignment_2(), "rule__Context__ItAssignment_2");
					put(grammarAccess.getContextAccess().getConstraintAssignment_3(), "rule__Context__ConstraintAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			com.avaloq.tools.dslsdk.check.ui.contentassist.antlr.internal.InternalCheckParser typedParser = (com.avaloq.tools.dslsdk.check.ui.contentassist.antlr.internal.InternalCheckParser) parser;
