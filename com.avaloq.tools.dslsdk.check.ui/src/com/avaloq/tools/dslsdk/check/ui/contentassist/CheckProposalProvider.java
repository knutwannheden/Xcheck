...
public class CheckProposalProvider extends AbstractCheckProposalProvider {
  ...
  /**
   * Override the Xbase standard. Create STRING completion proposals with linked edit mode.
   * <p>
   * {@inheritDoc}
   */
  @Override
  ...
  @Override
  // CHECKSTYLE:OFF
  public void completeContext_ContextType(final EObject model, final org.eclipse.xtext.Assignment assignment, final ContentAssistContext context, final ICompletionProposalAcceptor acceptor) {
    // CHECKSTYLE:ON
    JvmType parameterType = typeReferences.findDeclaredType(EObject.class, model);
    typeProposalProvider.createSubTypeProposals(parameterType, this, context, CheckPackage.Literals.CONTEXT__CONTEXT_TYPE, TypeMatchFilters.all(IJavaSearchConstants.INTERFACE), acceptor);
