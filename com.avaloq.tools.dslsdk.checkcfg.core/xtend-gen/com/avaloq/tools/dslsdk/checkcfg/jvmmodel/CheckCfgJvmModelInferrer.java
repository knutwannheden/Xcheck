package com.avaloq.tools.dslsdk.checkcfg.jvmmodel;
...
public class CheckCfgJvmModelInferrer extends AbstractModelInferrer {
   ...
   */
  protected void _infer(final CheckConfiguration element, final IAcceptor<JvmDeclaredType> acceptor, final boolean isPrelinkingPhase) {
  }
  ...
  public void infer(final EObject element, final IAcceptor<JvmDeclaredType> acceptor, final boolean isPrelinkingPhase) {
    if (element instanceof CheckConfiguration) {
      _infer((CheckConfiguration)element, acceptor, isPrelinkingPhase);
    } else {
