...
import com.avaloq.tools.dslsdk.checkcfg.checkcfg.CheckcfgFactory;
...
public class CheckcfgPackageImpl extends EPackageImpl implements CheckcfgPackage
{
	 ...
	 * @see com.avaloq.tools.dslsdk.checkcfg.checkcfg.CheckcfgPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getCheckConfiguration_Label()
	{
	 ...
	 * @generated
	 */
	public EReference getCheckConfiguration_CatalogConfigurations()
	{
	...
	{
		return (EAttribute)checkConfigurationEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents()
	{
		...
		createEAttribute(checkConfigurationEClass, CHECK_CONFIGURATION__LABEL);
		createEReference(checkConfigurationEClass, CHECK_CONFIGURATION__CATALOG_CONFIGURATIONS);
	...
	public void initializePackageContents()
	{
		...
		initEAttribute(getCheckConfiguration_Label(), theEcorePackage.getEString(), "label", null, 0, 1, CheckConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCheckConfiguration_CatalogConfigurations(), this.getConfiguredCatalog(), null, "catalogConfigurations", null, 0, -1, CheckConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(severityKindEEnum, SeverityKind.INHERIT);
