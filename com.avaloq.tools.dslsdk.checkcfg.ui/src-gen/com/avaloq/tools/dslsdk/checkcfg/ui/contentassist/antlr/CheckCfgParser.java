...
* generated by Xtext
*/
package com.avaloq.tools.dslsdk.checkcfg.ui.contentassist.antlr;
...
public class CheckCfgParser extends AbstractContentAssistParser {
	...
	@Override
	protected com.avaloq.tools.dslsdk.checkcfg.ui.contentassist.antlr.internal.InternalCheckCfgParser createParser() {
		com.avaloq.tools.dslsdk.checkcfg.ui.contentassist.antlr.internal.InternalCheckCfgParser result = new com.avaloq.tools.dslsdk.checkcfg.ui.contentassist.antlr.internal.InternalCheckCfgParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCheckConfigurationAccess().getLabelAssignment_2(), "rule__CheckConfiguration__LabelAssignment_2");
					put(grammarAccess.getCheckConfigurationAccess().getCatalogConfigurationsAssignment_4(), "rule__CheckConfiguration__CatalogConfigurationsAssignment_4");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			com.avaloq.tools.dslsdk.checkcfg.ui.contentassist.antlr.internal.InternalCheckCfgParser typedParser = (com.avaloq.tools.dslsdk.checkcfg.ui.contentassist.antlr.internal.InternalCheckCfgParser) parser;
