 ...
 *******************************************************************************/
package com.avaloq.tools.dslsdk.checkcfg.ui.outline;
...
import com.avaloq.tools.dslsdk.checkcfg.ui.syntaxcoloring.SemanticHighlightingConfiguration;
...
public class CheckCfgOutlineTreeProvider extends DefaultOutlineTreeProvider {
  ...
  // CHECKSTYLE:OFF
  /**
   * Gets the outline node text for a Check Configuration model. Uses given <em>label</em> and not derived name.
   * 
   * @param checkConfiguration
   *          the check configuration model
   * @return a styled string
   */
  protected Object _text(final CheckConfiguration checkConfiguration) {
    // CHECKSTYLE:ON
    return new StyledString(safeName(checkConfiguration.getLabel()));
  }
