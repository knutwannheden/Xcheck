...
package com.avaloq.tools.dslsdk.check.validation; // NOPMD
...
public class Messages extends NLS {
  ...
  private static final String BUNDLE_NAME = "com.avaloq.tools.dslsdk.check.validation.messages"; //$NON-NLS-1$
  ...
  public static String CheckJavaValidator_FORMAL_PARAMETER_TYPE;
  ...
  public static String CheckJavaValidator_UNSUPPORTED_FEATURE;
