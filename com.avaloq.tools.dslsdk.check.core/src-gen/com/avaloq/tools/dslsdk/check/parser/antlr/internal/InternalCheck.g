...
(
		{ 
	        newCompositeNode(grammarAccess.getCheckCatalogAccess().getImportsImportParserRuleCall_3_0()); 
	    }
...
(
    ...
    {
    	newLeafNode(otherlv_16, grammarAccess.getCheckCatalogAccess().getRightCurlyBracketKeyword_11());
    }
)
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getFormalParameterAccess().getParameterJvmFormalParameterParserRuleCall_0_0()); 
	    }
		lv_parameter_0_0=ruleJvmFormalParameter		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getFormalParameterAccess().getEqualsSignKeyword_1());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getFormalParameterAccess().getDefaultValueXFormalParameterDefaultValueLiteralParserRuleCall_2_0()); 
	    }
		lv_defaultValue_2_0=ruleXFormalParameterDefaultValueLiteral		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFormalParameterRule());
	        }
       		set(
...
(
		...
		{
			newLeafNode(lv_label_3_0, grammarAccess.getFormalParameterAccess().getLabelSTRINGTerminalRuleCall_3_0()); 
		}
		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getContextAccess().getContextTypeJvmTypeReferenceParserRuleCall_1_0()); 
	    }
		lv_contextType_1_0=ruleJvmTypeReference		{
	        if ($current==null) {
...
(
		lv_it_2_0=RULE_ID
		{
			newLeafNode(lv_it_2_0, grammarAccess.getContextAccess().getItIDTerminalRuleCall_2_0()); 
		}
		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getContextAccess().getConstraintXBlockExpressionParserRuleCall_3_0()); 
	    }
		lv_constraint_3_0=ruleXBlockExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getContextRule());
	        }
       		set(
...
(
	...
	otherlv_5=RULE_ID
	{
		newLeafNode(otherlv_5, grammarAccess.getXIssueExpressionAccess().getMarkerFeatureEStructuralFeatureCrossReference_3_1_0_1_0()); 
	}
...
(
	...
	otherlv_8=RULE_ID
	{
		newLeafNode(otherlv_8, grammarAccess.getXIssueExpressionAccess().getMarkerFeatureEStructuralFeatureCrossReference_3_1_1_1_1_0()); 
	}
...
(
    ...
    |
    { 
        newCompositeNode(grammarAccess.getXPrimaryExpressionAccess().getXGuardExpressionParserRuleCall_13()); 
    }
    this_XGuardExpression_13=ruleXGuardExpression
    { 
        $current = $this_XGuardExpression_13.current; 
        afterParserOrEnumRuleCall();
    }

    |
    { 
        newCompositeNode(grammarAccess.getXPrimaryExpressionAccess().getXIssueExpressionParserRuleCall_14()); 
    }
    this_XIssueExpression_14=ruleXIssueExpression
    { 
        $current = $this_XIssueExpression_14.current; 
        afterParserOrEnumRuleCall();
    }
)
;
