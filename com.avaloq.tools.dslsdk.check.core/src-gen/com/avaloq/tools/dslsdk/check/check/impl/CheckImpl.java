 ...
 * <ul>
 *   <li>{@link com.avaloq.tools.dslsdk.check.check.impl.CheckImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.avaloq.tools.dslsdk.check.check.impl.CheckImpl#getSeverityRange <em>Severity Range</em>}</li>
 *   <li>{@link com.avaloq.tools.dslsdk.check.check.impl.CheckImpl#isFinal <em>Final</em>}</li>
 *   <li>{@link com.avaloq.tools.dslsdk.check.check.impl.CheckImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link com.avaloq.tools.dslsdk.check.check.impl.CheckImpl#getDefaultSeverity <em>Default Severity</em>}</li>
 *   <li>{@link com.avaloq.tools.dslsdk.check.check.impl.CheckImpl#getId <em>Id</em>}</li>
 *   <li>{@link com.avaloq.tools.dslsdk.check.check.impl.CheckImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link com.avaloq.tools.dslsdk.check.check.impl.CheckImpl#getFormalParameters <em>Formal Parameters</em>}</li>
 *   <li>{@link com.avaloq.tools.dslsdk.check.check.impl.CheckImpl#getGivenMessage <em>Given Message</em>}</li>
 *   <li>{@link com.avaloq.tools.dslsdk.check.check.impl.CheckImpl#getContexts <em>Contexts</em>}</li>
 *   <li>{@link com.avaloq.tools.dslsdk.check.check.impl.CheckImpl#getMessage <em>Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
